...
class HandEye2(Parameters, MotionModel):
# class HandEye(PoseSet, MotionModel):
  ...
  def init(all_pose, pose_init, names=None):
    # p = pose
    return HandEye2(all_pose, pose_init.board['poses'], pose_init.camera['poses'], pose_init.selected_boards, pose_init.times, names)