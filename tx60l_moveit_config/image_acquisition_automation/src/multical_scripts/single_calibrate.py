...
class Calibrator():
    ...
    def calibrate(self, image=None, save=True, show=False):
        ...
        objp[:, :2] = np.mgrid[0:11, 0:8].T.reshape(-1, 2)*square_len
        ...
        images = glob.glob('D:/MY_DRIVE_N/Masters_thesis/Dataset/V10_debug/data/train/test/*.png')
        ...
        for fname in images:
            ...
            #     img = cv2.drawChessboardCorners(img, (13, 10), corners2, ret)
            #     if (True):
